!(function (t, e) {
  ...
  var mt = "top",
    ...
    jt = "beforeWrite",
    Ht = "afterWrite",
    Bt = [xt, "read", St, Nt, "main", Pt, jt, "write", Ht];
  function Rt(t) {
    ...
    static dataApiKeydownHandler(t) {
      ...
      if (t.key !== Ve)
        return t.key === Xe || t.key === Ye
          ...
          : void ((e && "Space" !== t.key) || hi.clearMenus());
      n.hide();
    }
  }
  ...
  const Ci = { backdrop: !0, keyboard: !0, focus: !0 },
    ki = {
  ...
  class un extends B {
    ...
    dispose() {
      clearTimeout(this._timeout),
        j.off(this._element.closest(".modal"), cn, this._hideModalHandler),
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((t) => {
        ...
        j.on(this._element.closest(".modal"), cn, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
    ...
    _enter(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t && (e._activeTrigger["focusin" === t.type ? "focus" : hn] = !0),
    ...
    _leave(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._activeTrigger["focusout" === t.type ? "focus" : hn] =
